...
module.exports = {
	...
	run: async (client, interaction) => {
		...
		function sendRoleSelector() {
			...
			.setDescription('Use the below dropdown menu to select the roles you want to have. If you\'d like to remove the role, select it again.\nNote that these roles don\'t grant you extra permissions, you are allowed to select as many roles as you want!')
			.setColor('BLURPLE')
			.setFooter({ text: 'use the below button to show your roles!'})

			const roleSelectorRow = new MessageActionRow()
			.addComponents(
