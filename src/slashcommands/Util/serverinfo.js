...
const run = (client, interaction) => {
	try {
      ...
      .addFields(
        ...
        { name: 'Total Members', value: `${interaction.guild.members.cache.size}`, inline: true },
        ...
        { name: 'Total Text Channels', value: `${interaction.guild.channels.cache.filter(channel => channel.type === 'text').size}`, inline: true },
        { name: 'Total Voice Channels', value: `${interaction.guild.channels.cache.filter(channel => channel.type === 'voice').size}`, inline: true },
        ...
        { name: 'Total Boosters', value: `${interaction.guild.premiumSubscriptionCount}`, inline: true },
      )
