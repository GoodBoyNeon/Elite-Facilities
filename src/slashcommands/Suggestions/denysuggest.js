...
module.exports = {
  ...
  run: async (client, interaction) => {
    ...
    if (!interaction.member.roles.cache.has("940999691032743976"))
    ...
    let denyEmbed = new MessageEmbed()
      ...
      .setFooter({
        text: `denied by ${interaction.member.user.tag}`,
        iconURL: `${interaction.member.displayAvatarURL()}`,
      })
      .setColor("RED")
      .addFields({
        name: "Status",
        value: `\<:nononon:908293430260695080> thank you for your suggestion. but the community does not seem to be interested in it for now.\n**Reason:** ${reason}`,
      });
